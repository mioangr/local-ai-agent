...
RUNTIME_AGENT_DIR="$RUNTIME_DIR/agent"
RUNTIME_API_DIR="$RUNTIME_DIR/api"
RUNTIME_CLI_DIR="$RUNTIME_DIR/cli"
RUNTIME_SHARED_DIR="$RUNTIME_DIR/shared"
RUNTIME_UPDATER_DIR="$RUNTIME_DIR/updater"
RUNTIME_WWW_DIR="$RUNTIME_DIR/www"
RUN_DIR="$RUNTIME_CLI_DIR"
...
export RUNTIME_DIR
export RUNTIME_AGENT_DIR
export RUNTIME_API_DIR
export RUNTIME_CLI_DIR
export RUNTIME_SHARED_DIR
export RUNTIME_UPDATER_DIR
export RUNTIME_WWW_DIR
export RUN_DIR
export SETTINGS_DIR
export REPOS_DIR
export LOGS_DIR
